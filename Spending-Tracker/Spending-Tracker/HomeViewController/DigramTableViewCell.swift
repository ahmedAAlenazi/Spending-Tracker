...
class DigramTableViewCell: UITableViewCell, ChartViewDelegate {
...
//        x-axis limit line
            ...
            let ll1 = ChartLimitLine(limit: 10000, label: NSLocalizedString("Upper Limit", comment: ""))
            ll1.lineWidth = 4
            ll1.lineDashLengths = [5, 5]
            ll1.labelPosition = .topRight
            ll1.valueFont = .systemFont(ofSize: 10)

            let ll2 = ChartLimitLine(limit: 1000, label: NSLocalizedString("Lower Limit", comment: ""))
            ll2.lineWidth = 4
