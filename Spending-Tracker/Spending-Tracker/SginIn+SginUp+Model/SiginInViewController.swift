...
//        bottonSignIn.centerXAnchor.constraint(equalTo:self.view.centerXAnchor).isActive = true// centerXAnchor which set over the view center
        bottonSignIn.bottomAnchor.constraint(equalTo:self.view.safeAreaLayoutGuide.bottomAnchor, constant: -200).isActive = true // BottomAnchor to set with botton target
        ...
        bottonSignIn.leftAnchor.constraint(equalTo:self.view.centerXAnchor,constant:-150).isActive = true
...
//        bottonSignUp.centerXAnchor.constraint(equalTo:self.view.centerXAnchor).isActive = true// centerXAnchor which set over the view center
        bottonSignUp.bottomAnchor.constraint(equalTo:self.view.safeAreaLayoutGuide.bottomAnchor, constant: -200).isActive = true // BottomAnchor to set with botton target
        bottonSignUp.widthAnchor.constraint(equalToConstant: 120.0).isActive = true // Width Anchor to set appropriate width
